...
loadstring(game:HttpGet("https://raw.githubusercontent.com/LenivayZopaKotaWork/Pluty-Hub/refs/heads/main/mobile.lua"))()
		...
		TextLabel.TextColor3 = Color3.fromRGB(0, 0, 128) -- базовый темно-синий
		TextLabel.Parent = ImageButton
		
		-- Градиент текста
		local gradient = Instance.new("UIGradient")
		gradient.Color = ColorSequence.new{
		    ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 0, 128)),  -- темно-синий
		    ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 128, 255)) -- светло-синий
		}
		...
		UIS.InputChanged:Connect(function(input)
			...
			----Button
					...
					ImageButton.Image = "rbxassetid://1648938003" -- Твой ассет
					ImageButton.Parent = ScreenGui
					ImageButton.ZIndex = 2 -- поверх всего
					...
					Label.Size = UDim2.new(1, 0, 0, 18) -- ширина = кнопке
					Label.AnchorPoint = Vector2.new(0.5, 1)
					Label.Position = UDim2.new(0.5, 0, 0, -2) -- чуть выше кнопки
					Label.BackgroundTransparency = 1
					Label.Text = "Silent Aim"
					Label.TextColor3 = Color3.fromRGB(255, 255, 255)
					Label.TextScaled = true
					Label.Font = Enum.Font.GothamBold
					Label.Parent = ImageButton -- Привязываем к кнопке!
